...
The NiuViews dataset is generated for the multi-view cooperative perception of intelligent vehicles in the V2V communication scenario. It provides visual and LiDAR information collected from different perspectives when the car is moving.  We use the [CARLA simulator](http://carla.org/ "Carla simulator") to complete this work, which can provide us with realistic environment modeling, as well as dynamics and sensors simulations of various vehicle.
